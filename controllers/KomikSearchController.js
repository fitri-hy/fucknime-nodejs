...
exports.index = async (req, res) => {
    try {
        ...
        const apiUrl = `${process.env.BASE_URL}/v1/komik/search?q=${encodeURIComponent(q)}&page=${page}`;
        ...
        res.render('komik-search', { 
            site_title: 'Pencarian | Komik',
			site_desc: 'Temukan informasi komik yang Anda cari dengan mudah dan cepat.',
