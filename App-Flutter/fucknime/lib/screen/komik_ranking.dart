...
class KomikRankingScreen extends StatefulWidget {
  const KomikRankingScreen({super.key});

  @override
  _KomikRankingScreenState createState() => _KomikRankingScreenState();
}

class _KomikRankingScreenState extends State<KomikRankingScreen> {
  int currentPage = 1;
  ...
  Future<List<dynamic>> fetchkomikList() async {
    final response = await http.get(
      Uri.parse('${ApiConfig.baseUrl}/komik/list?order=meta_value_num&page=$currentPage'),
      headers: {
