...
class KomikPopularScreen extends StatefulWidget {
  const KomikPopularScreen({super.key});

  @override
  _KomikPopularScreenState createState() => _KomikPopularScreenState();
}

class _KomikPopularScreenState extends State<KomikPopularScreen> {
  int currentPage = 1;
  ...
  Future<List<dynamic>> fetchkomikList() async {
    final response = await http.get(
      Uri.parse('${ApiConfig.baseUrl}/komik/list?order=rand&page=$currentPage'),
      headers: {
